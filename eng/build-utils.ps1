...
function Make-BootstrapBuild() {
    ...
    $projectPath = "proto.proj"

    Run-MSBuild $projectPath "/restore" -logFileName "Bootstrap" -configuration $bootstrapConfiguration
    Copy-Item "artifacts\bin\fsc\$bootstrapConfiguration\$bootstrapTfm\*" -Destination $dir
